...
class _CustomerDataSource implements CustomerDataSource {
  ...
  @override
  Future<HttpResponse<CustomerInfoResponse>> getCustomerInfo() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<CustomerInfoResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late CustomerInfoResponse _value;
    try {
      _value = CustomerInfoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<CustomerInfoResponse>> registerCustomer(
      RegistrationModelRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
