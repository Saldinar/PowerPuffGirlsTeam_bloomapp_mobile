...
class _ProductDataSource implements ProductDataSource {
  ...
  Future<HttpResponse<ProductDetailsResponse>> getProductDetails(
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<HttpResponse<ProductDetailsResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<CatalogProductResponse>> getProductsByManufacturerId(
    ...
    final _options =
        _setStreamType<HttpResponse<CatalogProductResponse>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CatalogProductResponse _value;
    try {
      _value = CatalogProductResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
