...
// // import 'lib/domain/entity/auth/auth_entity.dart'; // Импортируем сущности, если нужно
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  // Инициализация репозитория с использованием GetIt
  ...
  void _handleSubmit() async {
    if (_formKey.currentState!.validate()) {
      final request = AuthRequestEntity(
        email: _emailController.text.trim(),
        password: _passwordController.text.trim(),
        userName: '', // Можно добавить, если нужно
        isGuest: false, // Если есть гость, добавь флаг
      );
