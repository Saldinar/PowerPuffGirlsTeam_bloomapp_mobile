...
class CustomPropertiesResponse {
  ...
  factory CustomPropertiesResponse.fromJson(Map<String, dynamic> json) =>
      _$CustomPropertiesResponseFromJson(json);

  Map<String, dynamic> toJson() => _$CustomPropertiesResponseToJson(this);
}
